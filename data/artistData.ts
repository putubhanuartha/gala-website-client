import { LineupCardPropsType } from "@/app/lineup/(component)/lineup-card";
export const domesticArtist: LineupCardPropsType[] = [
	{
		...
		description: `Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio ea
			...
			at quaerat asperiores ipsum iusto, impedit eius voluptatem libero, qui
			blanditiis. Maiores fugit ex consectetur provident libero rerum sit?
			Fugit facere commodi eos.`,
		imgUrl: "/assets/lineup/domestic/ardhito.jpg",
		title: "ardhito pramono",
	},
	{
		childrenHtml:
		...
		molestiae est hic! Minima tempora cumque cum laudantium architecto
		officiis itaque necessitatibus? Autem.`,
		imgUrl: "/assets/lineup/domestic/hindia.jpg",
		title: "hindia",
	},
	{
		childrenHtml:
		...
		molestiae est hic! Minima tempora cumque cum laudantium architecto
		officiis itaque necessitatibus? Autem.`,
		imgUrl: "/assets/lineup/domestic/nadin-1.jpg",
		title: "nadin amizah",
	},
	{
		childrenHtml:
		...
		blanditiis. Maiores fugit ex consectetur provident libero rerum sit?
		Fugit facere commodi eos.`,
		imgUrl: "/assets/lineup/domestic/pamungkas-2.jpg",
		title: "pamungkas",
	},
];
...
export const interArtist: LineupCardPropsType[] = [
	{
		...
		blanditiis. Maiores fugit ex consectetur provident libero rerum sit?
		Fugit facere commodi eos.`,
		imgUrl: "/assets/lineup/international/the1975.jpg",
		title: "the 1975",
	},
	{
		childrenHtml:
		...
		molestiae est hic! Minima tempora cumque cum laudantium architecto
		officiis itaque necessitatibus? Autem.`,
		imgUrl: "/assets/lineup/international/gregory.jpg",
	...
	},
	{
		...
		molestiae est hic! Minima tempora cumque cum laudantium architecto
		officiis itaque necessitatibus? Autem.`,
		imgUrl: "/assets/lineup/international/keshi.jpg",
		title: "keshi",
	},
	{
		childrenHtml:
		...
		deleniti fugiat delectus voluptates fugit animi, labore culpa
		consequuntur quibusdam, hic impedit autem aliquid, minus sint
		exercitationem ipsum. Voluptatum perspiciatis nihil, maxime facere at,
		cum officiis aliquam, nam eligendi est nulla.`,
		imgUrl: "/assets/lineup/international/lewis.jpg",
		title: "lewis capaldi",
	},
];